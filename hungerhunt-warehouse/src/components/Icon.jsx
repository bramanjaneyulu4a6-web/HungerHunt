const paths = {
  ...
  /* The three tabs. Each one is the thing itself — a taped box going out, the
     shelf it came off, the lorry bringing more — so the icon carries the
     screen even before the label underneath it is read. */
